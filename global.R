...
dt_by <- read.csv('sikd_gabung.csv')
...
dt_by <- dt_by %>% select(c('usia',"status_perkawinan","jml_anak","pendapatan","akses_ke_fasilitas","akses_toilet","air_bersih","menerima_bantuan")) 
